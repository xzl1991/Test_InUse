...
public class PoolConnect {
	...
	private static void initDriver() {
		...
		// load mysql driver
		try {
			driver = (Driver) Class.forName("net.sourceforge.jtds.jdbc.Driver")
					.newInstance();
	...
	public synchronized static void printDebugMsg(PrintStream out) {
		...
		msg.append("debug message in " + PoolConnect.class.getName());
		msg.append("\r\n");
...
class ConnectionWrapper implements InvocationHandler {
	...
	public Object invoke(Object proxy, Method m, Object[] args)
		...
		if (CLOSE_METHOD_NAME.equals(m.getName())) {
			PoolConnect.pushConnectionBackToPool(this);
		} else {
