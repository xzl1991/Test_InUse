...
public class ZXingCode {
    ...
    {  
        ...
        {  HttpServletResponse response = null;
            getLogoQRCode("https://www.baidu.com/", null, "跳转到百度的二维码",response);
            getLogoQRCode("http://weixin.qq.com/r/Wf1AWC-EHXJirWs796hL", null, "", response);
        }  
        catch (Exception e)  
        {  
            e.printStackTrace();  
    ...
    public static String getLogoQRCode(String qrUrl,HttpServletRequest request,String productName,HttpServletResponse response)
    {
// String filePath = request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        ...
        String filePath = "D:/TDDOWNLOAD/ss0.jpg";  //TODO 
...
// outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
            ...
            ImageIO.write(image, "png", new File("D:/TDDOWNLOAD/TDC-" + new Date().getTime() + "test.png")); //TODO 

            String imageBase64QRCode =  Md5_SHA_1.base64Encode(baos.toByteArray());
            baos.close();
